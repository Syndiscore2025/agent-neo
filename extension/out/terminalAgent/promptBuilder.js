...
exports.DEFAULT_PROMPT_TEMPLATE = void 0;
exports.buildPrompt = buildPrompt;
/** Ships with the extension; overridable via settings. */
exports.DEFAULT_PROMPT_TEMPLATE = [
...
function buildPrompt(template, vars) {
    ...
    for (const block of blocks) {
        const substituted = block.replace(PLACEHOLDER_RE, (_m, name) => (name in resolved ? resolved[name] : '\u0000DROP\u0000'));
        const lines = substituted
            .split('\n')
            .filter(line => !line.includes('\u0000DROP\u0000'));
        if (lines.length === 0 || isOnlyLabels(lines)) {
            continue;
        }
